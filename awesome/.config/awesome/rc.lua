...
tyrannical.tags = {
    ...
    { name = "Internet",
      ...
      class = { "Firefox", "Chromium", "firefox-developer" } },
    { name = "Email",
      init = true,
      exclusive = true,
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "e",
        ...
        {description = "view all clients of current tag", group = "tag"}
    ),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "c",
        ...
        {description = "place centered", group = "client"})
)
...
for i = 1, 12 do
    globalkeys = awful.util.table.join(globalkeys,
        awful.key({ modkey }, "F" .. i,
                  ...
                  {description = "view screen #"..i, group = "screen"})
    )
end
